function Skills() {
  return (
    <div className="flex md:flex-row flex-col items-start xl:gap-16 gap-10 xl:ml-32 md:ml-10 mx-8 mt-5">
      <div className="xl:max-w-[50%] md:max-w-[93%] max-w-[98%]">
        <h2 className=" text-gray-600 text-2xl font-semibold  xl:text-3xl xl:text-gray-900">
          Skills
        </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6 max-w-full">
          ...
          <div className="py-3 px-0 bg-blue-500 text-center text-medium text-gray-100 rounded-md shadow-md transform transition-transform duration-300 hover:scale-[1.06]">
            Tailwind CSS
          </div>
          <div className="py-3 bg-blue-500 text-center text-medium text-gray-100 rounded-md shadow-md transform transition-transform duration-300 hover:scale-[1.07]">
            PostgreSQL
          </div>
        </div>
      </div>
      ...
      <div className="md:max-w-[50%] max-w-full">
        ...
        <div className="flex flex-col gap-6 xl:mr-10">
          <div>
